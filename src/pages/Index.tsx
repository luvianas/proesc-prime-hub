                ...
                {userRole === 'admin' && <div className="grid md:grid-cols-2 gap-4">
                     <div className="space-y-2">
                       ...
                       <div className="flex gap-2">
                         <Input id="wa-admin" placeholder="(55) 99999-9999" value={adminWhatsApp} onChange={e => {
                           ...
                           <DialogContent className="sm:max-w-md">
                             ...
                             <div className="space-y-4">
                               ...
                               <div className="space-y-2">
                                 ...
                                 <Input id="phone-input" placeholder="Digite apenas números" onChange={e => {
                              const value = e.target.value.replace(/\D/g, '');
                              let formatted = value;
                              if (value.length >= 2) {
                                formatted = `(${value.slice(0, 2)})`;
                    ...
                    <div className="space-y-2">
                      ...
                      <textarea id="cal-admin" placeholder="<iframe ...> ou URL" value={adminCalendarUrl} onChange={e => setAdminCalendarUrl(e.target.value)} className="flex min-h-[80px] w-full rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 resize-vertical" rows={3} />
                    </div>
                  </div>}
